...
### 8. 내로또 - AI 로또 예측기 - 개인 프로젝트 (2026.02)
- 역할: 풀스택 개발자
- 프로젝트 설명: AI 기반 로또 6/45 및 연금복권 720+ 번호 예측 서비스
- 주요 기능:
  * CDM 확률 모델 기반 번호 예측 시스템
  * 백테스트 검증 시스템 (전체 회차 역추적 검증)
  * 로또 6/45 + 연금복권 720+ 분석
  * 스마트 랜덤 번호 생성기 (홀짝/고저/합계/번호대 균형)
  * 과거 회차 당첨번호 비교 기능
  * Google AdSense 광고 연동
- 기술 스택: Next.js 16, React 19, Prisma, PostgreSQL (Neon), ml-regression, Tailwind CSS
- 배포: Vercel
